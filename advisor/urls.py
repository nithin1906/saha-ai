...
urlpatterns = [
    ...
    path('api/mobile-chat/', views.mobile_chat_api, name='api_mobile_chat'),
    path('api/stock-price/<str:ticker>/', views.stock_price_api, name='stock_price_api'),
    path('api/portfolio/', views.portfolio_api, name='portfolio_api'),
    path('api/portfolio/details/', views.portfolio_api, name='portfolio_details'),
