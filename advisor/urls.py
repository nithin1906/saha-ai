...
urlpatterns = [
    ...
    # Conversational AI & NLP Endpoints
    path("nlp/chat/", chat_message, name="nlp-chat"),

    path("nlp/advisor/", advisor_response, name="financial-advisor"),
